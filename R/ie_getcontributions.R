...
#' @import httr
#' @template ie
#' @param amount The amount of the contribution in US dollars in one of the following formats: 500 (exactly 500 dollars), >|500 (greater than or equal to 500 dollars), <|500 (less than or equal to 500 dollars)
...
#' @param date date of the contribution in ISO date format (with ><|2006-08-06|2006-09-12 as a between-dates search).
#' @param for_against Either \dQuote{for} or \dQuote{against}. When organizations run ads against a candidate, they are counted as independent expenditures with the candidate as the recipient. This parameter can be used to filter contributions meant for the candidate and those meant to be against the candidate.
